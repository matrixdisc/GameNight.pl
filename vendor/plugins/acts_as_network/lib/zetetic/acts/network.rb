  ...
  module Acts #:nodoc:  
    ...
    module Union
      ...
      module ClassMethods
        ...
        #     acts_as_union   :acquaintances, [:friends, :colleagues]
        #   end
        #
        # In this case a call to the +acquaintances+ method will return a UnionCollection on both 
        # a person's +friends+ and their +colleagues+. Likewise, finder operations will work across 
        ...
        #   billy = stephen.acquaintances.find_by_name('Billy')
        #
